...
var scaffolding = function scaffolding(projectInfo, callback) {
    async.waterfall([mkdir('src'), mkdir('dist'), mkdir('test'), mkdir('doc'), function (callback) {
        process.stdout.write('Write .gspconfig ... ');
        var tmpl = fs.readFileSync(path.join(__dirname, 'scaffolds/_gspconfig'), { encoding: 'utf8' });
        ...
        var scaffolds = path.join(__dirname, 'scaffolds');
...
exports.scaffold = function (options, projectInfo) {
    ...
    prompt.get(schema, function (err, result) {
        ...
        var continuing = result.confirm.toLowerCase() !== 'y';
