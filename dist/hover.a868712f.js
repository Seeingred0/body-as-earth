...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"hover.js":[function(require,module,exports) {
"use strict";
...
var hoverEffect = function hoverEffect(opts) {
  ...
  var object = new THREE.Mesh(geometry, mat); // scene.add(object);
...
var MouseCursor = /*#__PURE__*/function () {
  ...
  _createClass(MouseCursor, [{
    ...
    key: "enterMouse",
    value: function enterMouse() {
      var cursor = document.querySelector('.cursor');

      _gsap.default.to(cursor, 1, {
        autoAlpha: 1,
        ease: Power4.easeIn
      });
    }
    ...
    key: "updateOnHover",
    value: function updateOnHover(e) {
...
mouseCursor.render(); //demo jquery

$(document).ready(function () {
  $cursor = $('.cursor');
  $('.design, .design-container, .info, .img').mouseup(function () {
    $cursor.removeClass('mouse-down');
  }).mousedown(function () {
    $cursor.addClass('mouse-down');
  });
  $('.design-container, .design').hover(function () {
    $cursor.addClass("img-hover");
  }, function () {
    $cursor.removeClass("img-hover");
  });
  $('.title, .design, .photographer, .sub-nav div').hover(function () {
    $cursor.addClass("orange");
  }, function () {
    $cursor.removeClass("orange");
  });
  $('.menu-container').click(function () {
    $('.design-container, .design, .img').toggleClass('active');
  }); // on any arrow keys press

  $(document).keydown(function (e) {
    if (e.keyCode > 36 && e.keyCode < 41) {
      $('.design-container, .design, .info, .menu-container').toggleClass('show');
    }
